...
export const ScrollingBanner = () => {
  return (
    <div className="w-full bg-black overflow-hidden whitespace-nowrap relative">
      ...
      <div className="absolute inset-y-0 left-0 w-[32rem] bg-gradient-to-r from-black to-transparent"></div>
      <div className="absolute inset-y-0 right-0 w-[32rem] bg-gradient-to-l from-black to-transparent"></div>
    </div>
  );
};