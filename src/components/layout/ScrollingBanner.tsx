  ...
  return (
    <div className="w-full bg-black overflow-hidden whitespace-nowrap relative">
      <div className="inline-block animate-scroll">
        <span className="inline-block text-[#13E881] py-2 pr-8 font-poppins text-sm">
      ...
      <div className="absolute inset-y-0 left-0 w-96 bg-gradient-to-r from-black to-transparent"></div>
      <div className="absolute inset-y-0 right-0 w-96 bg-gradient-to-l from-black to-transparent"></div>
    </div>
  );
};